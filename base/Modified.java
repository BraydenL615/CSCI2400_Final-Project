...
public class Modified extends Dirtbike {
    int driveChainChange = 6;
    int airFilterChange = 1;
    int tireChange = 5;
    int brakePadChange = 3;

    public void ModifiedMenu() throws IOException{
        System.out.println("Welcome to the Modified dirtbike menu");
